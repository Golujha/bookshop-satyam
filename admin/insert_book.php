        ...
        <div class="row">
            ...
            <div class="row">
                    <div class="col-12 mb-3 d-flex justify-content-between">
                        <h2 class="text-white m-0 p-0">Insert new book</h2>
                        <a href="manage_book.php" class="btn btn-light">Go Back</a>
                    </div>
                </div>
                <div class="card">
                <div class="card-header">
                    <h5>Insert Books Details</h5>
                </div>
                <div class="card-body">
                   ...
                   <div class="mb-3 col">
                    ...
                    if(isset($_POST['create_book'])){
                      ...
                      $query = mysqli_query($connect, "insert into books (title,author,isbn,description,price,discount_price,
                      category,nos,no_of_page,cover_image)value ('$title','$author','$isbn','$description','$price','$discount_price','$category',
                      '$nos','$no_of_page','$cover_image')");
